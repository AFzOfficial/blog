...
const Footer = () => {
    ...
    return (
        <footer className="max-w-screen-xl mx-auto bg-zinc-950 p-4 sm:p-6 border-t border-zinc-800">

            <div className="flex flex-col items-center justify-center sm:flex-row sm:justify-between">
                <span className="text-sm text-center sm:text-left leading-loose	 font-medium">© 2023 <a target="_blank"
                    href="https://pycloud.space" className="underline">AFz</a>. All Rights Reserved. <br />
                ...
                <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    ...
                    <a target="_blank" href="https://github.com/AFzOfficial" className="transition hover:scale-125">
                    ...
                    <a target="_blank" href="#" className="transition hover:scale-125">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor"
                    ...
                    <a target="_blank" href="https://twitter.com/AFzOfficial" className="transition hover:scale-125">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor"
